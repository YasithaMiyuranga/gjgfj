...
<head>
    ...
    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('Admin/assets/css/style-rtl.css') }}" id="main-style-link">
    @endif
...
<body class={{ $color }}>
    @include('partision.events_sidebar')
    @include('partision.events_header')
                        ...
                        <div class="col-xl-5">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('useradmin.event_dashboard') }}">{{ __('Dashboard') }}</a>
                                </li>
                                @yield('breadcrumb')
                            </ul>
                        </div>
