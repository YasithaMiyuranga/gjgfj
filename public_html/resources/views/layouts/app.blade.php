...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/Company/' . config('app.company_favicon_icon')) }}"
        type="image/x-icon" />
...
<body class={{ $color }}>
                        ...
                        <div class="col-xl-5">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('useradmin.dashboard') }}">{{ __('Dashboard') }}</a>
                                </li>
                                @yield('breadcrumb')
                            </ul>
                        </div>
    ...
    {{-- Alert Modal --}}
    <div id="customAlert" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="customAlertLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
