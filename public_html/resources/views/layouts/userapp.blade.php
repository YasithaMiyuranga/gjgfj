...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/Company/' . $settings['app_icon']) }}">
    ...
    <!-- Add these lines to your Blade layout file -->
    <link rel="stylesheet" href="{{ asset('https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css') }}">
...
<body class="home-1">
    ...
    <!-- Header ======================-->
    <header class="header-section header-5 sticky-navbar">
        <div class="container">

            @include('partision.uNavigationbardesltop')

        </div>
    </header>
    <!-- Header ======================-->

    @include('partision.uNavigationbarmobile')
    ...
    <div class="main" data-bs-spy="scroll" data-bs-target="#navContentmenu" data-bs-root-margin="0px 0px -50%"
        ...
        <div id="particles-js"
            style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 999; pointer-events: none">
        </div>
        @yield('content')
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if ($errors->has('registerfail') || session('registerfail'))
                    ...
                    <form method="POST" action="{{ route('user.register.store') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <x-input id="name" class="form-control" type="text" name="name" required
                                autofocus value="{{ old('name') }}" maxlength="255" required />
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <x-input id="phone_number" class="form-control" type="number" name="phone_number"
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label"
                                for="confirmation_password">{{ __('Confirm Password') }}</label>
                            <x-input id="confirmation_password" class="form-control" type="password"
                                name="confirmation_password" value="{{ old('confirmation_password') }}" required />
                        </div>
                        <div class="mb-3">
                            <div class="col-12">
                        ...
                        <div class="mt-2 text-center">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal"type="submit">
                                {{ __('Login') }} </a>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('user.loginuser') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <x-input id="email_login" class="form-control" type="email" name="login_email"
                                value="{{ old('login_email') }}" required autofocus />
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label" for="password">{{ 'Password' }}</label>
                            <x-input id="password_login" class="form-control" type="password" name="login_password"
                        ...
                        <div class="my-1 text-center">
                            <a href="#" data-bs-toggle="modal"
                                data-bs-target="#forgotPasswordModal">{{ __('Forgot Password?') }}</a>
                        </div>
                        <div class="mt-2 text-center">
                            Don't have an account?
                            <a href="#" data-bs-toggle="modal"
                                data-bs-target="#registerModal">{{ __('Sign Up') }}</a>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <x-input id="forgot_email" class="form-control" type="email" name="email"
    ...
    {{-- @section('resetPasswordModal')
        @if (request()->routeIs('password.reset.user'))
            @include('auth.userreset-password')
        @endif
    @endsection --}}
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <x-input id="reset_email" class="form-control" type="email" name="email"
                                value="{{ old('email') }}" required autofocus />
                        </div>
                        <div class="form-group mb-3">
    ...
    <script src="{{ asset('assets/js/text-opacity.js') }}"></script>
    <!-- text-opacity -->
    ...
    <!-- Trigger the modal if there are any errors -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Check if the current URL contains 'reset-user-password'
            const url = new URL(window.location.href);
            if (url.pathname.includes('reset-user-password')) {
        ...
        $(document).ready(function() {
            ...
            // Show the login modal if there are errors or fail message
            @if ($errors->has('loginfailmsg') || session('loginfail'))
                $('#loginModal').modal('show');
            @endif

            // Show the register modal if there are errors or fail message
            @if ($errors->has('registerfail') || session('registerfail'))
                $('#registerModal').modal('show');
            @endif

            // Show the success message in the right-side corner
            @if (session('success'))
            ...
            // Show the forgot password modal if there are errors or message
            @if ($errors->has('email'))
                {
