<form action="{{ route('useradmin.supplier.add') }}" method="post" id="supplierForm">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="supplier_contact" name="supplier_contact" maxlength="10" required>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="btn_submit">Add Supplier</button>
    </div>
</form>
...
<script>
    ...
    document.getElementById('supplierForm').addEventListener('submit', function(e) {
        ...
        // Validate each field
        const fields = [
            { id: 'supplier_name', errorId: 'nameError', message: 'Supplier name is required.' },
            { id: 'supplier_contact', errorId: 'phoneError', message: 'Contact number is required.' },
            { id: 'supplier_city', errorId: 'cityError', message: 'City is required.' },
            { id: 'supplier_address', errorId: 'addressError', message: 'Address is required.' }
        ];
        ...
        if (supplierAddress.length > 255) {
            document.getElementById('addressError').textContent = 'Supplier address should not exceed 255 characters.';
            isValid = false;
        }
