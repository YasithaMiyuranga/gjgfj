        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="ProfileForm" action="{{ Route('employee.emp.updateprofile') }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                           <img src="{{ !empty(Auth::guard('employee')->user()->profile_image) ? asset(Auth::guard('employee')->user()->profile_image) : asset('assets/images/profile/Avatar.png') }}"
                                alt="Employee Image"
                            ...
                            <div class="form-wrapper-one shadow-sm rounded">
                                ...
                                <div class="mb-3">
                                    <label for="admin_type" class="form-label">Employee Type</label>
                                    <input type="text" id="emp_type" name="emp_type" class="form-control"
                                        value="{{ old('emp_type', auth()->user()->emp_type) }}" readonly>
                    ...
                    <div class="card-header">
                        <h3>{{ __('Employee Password Change') }}</h3>
                    </div>
                    <div class="card-body">
                        <form id="changePasswordForm" action="{{ Route('employee.emp.changepassword') }}" method="POST"
