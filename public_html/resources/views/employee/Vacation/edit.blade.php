...
<form method="post" action="{{ route('employee.vacations.update', ['vacation' => $vacation->id]) }}" id="vacationForm" data-ajax="true" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="form-group mb-3">
        ...
        <x-input id="status" class="form-control" type="text" name="status" value="pending" value="{{ $vacation->status }}" readonly />
    </div>
    <div class="form-group mb-3">
