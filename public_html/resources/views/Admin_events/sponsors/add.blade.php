...
<form method="post" action="{{ route('useradmin.events.sponsor_store') }}" enctype="multipart/form-data" id="artistAddForm" data-ajax="true">
    @csrf
    <div class="form-group mb-3">
        <label class="form-label" for="sponsor_name">{{ ('Sponsor Name   *') }}</label>
        <x-input id="sponsor_name" name="sponsor_name" class="form-control" type="text" required  value="{{ old('sponsor_name') }}" maxlength="255"/>
    ...
    <div class="form-group mb-3">
        ...
        <x-input id="phone_no" name="phone_no" class="form-control" type="text"/>
    ...
    <div class="form-group mb-3">
        ...
        <x-input id="website_url" name="website_url" class="form-control" type="text" value="{{ old('website_url') }}" maxlength="255" />
    ...
    <div class="d-flex mb-3">
        <div class="d-grid">
            <button class="btn btn-primary btn-block mt-2" type="submit">{{ ('Add Sponsor') }}</button>
        </div>
    </div>
</form>
<script>
