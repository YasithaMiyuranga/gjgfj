...
<script>
    ...
    // Inject table and date from localStorage
    document.addEventListener('DOMContentLoaded', function () {
        const tableHTML = localStorage.getItem('ticket_report_html');
        const reportDate = localStorage.getItem('ticket_report_date');
        
        document.getElementById('tableContainer').innerHTML = tableHTML || '<p>No report data found.</p>';
    });
</script>
</html>
