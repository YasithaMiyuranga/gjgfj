...
<title>Total Tickets Report</title>
<style>
    * {
        margin: 0;
        padding: 0;
...
<body>
    <div class="ticket">
        ...
        @foreach ($events as $event)
            @php
                $eventTickets = $tickets->where('eid', $event->eid);
            @endphp
                    ...
                    <table class="table" border="1" cellpadding="5" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: #e9ecef; font-weight: bold;">
                                ...
                                <td>{{ $totalSold }}</td>
                                <td>{{ number_format($totalSales, 2) }}</td> <!-- Total event sales -->
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="form-group">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn-print" id="printpagebutton" onclick="printBill()">Print Summary</button>
    </div>
</body>
</html>
