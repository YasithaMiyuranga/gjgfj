    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5></h5>
                <h3>Send Rent Items</h3>
            </div>
            <hr>
                <div class="card-body table-border-style">
                    <div class="col-xl-12">
                        <x-auth-validation-errors class="mb-4 text-danger" :errors="$errors" />
                        <form method="post" action="{{ route('useradmin.saverentitems') }}" id="sendForm">
                            @csrf
                            <?php
                            $user = Auth::user();
                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="rent_package_id" id="rent_package_id" class="form-control select2 mt-1">
                                            ...
                                            @foreach ($rentItemPackages as $rentItemPackage)
                                                <option value="{{ $rentItemPackage->id }}" {{ old('rent_package_id') == $rentItemPackage->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="employee_id" id="employee_id" class="form-control select2 mt-1">
                                            ...
                                            <option value="{{ $employee->emp_id }}"
                                                {{ old('employee_id') == $employee->emp_id ? 'selected' : '' }}>
                                                {{ $employee->name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" class="form-control" value="{{ old('customer_name') }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
            ...
            for (var i = 0; i < selectedItems.length; i++) {
                ...
                sendTableBody.append(
                    '<tr>' +
                        '<td>' + item.itemName + '</td>' +
                        '<td>' +
                            '<input type="number" class="form-control quantity-input-2" oninput="validateQuantity(this, \'quantityValidationMessage2-' + item.itemId + '\'); checkQuantity(this, ' + item.itemId + ', \'' + item.itemName + '\')" value="' + item.quantity + '">' +
