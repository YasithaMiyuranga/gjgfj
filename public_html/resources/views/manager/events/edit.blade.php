...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('manager.events.events_list') }}">{{ __('Events List') }}</a>
    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body table-border-style">
                ...
                <form method="post" action="{{ route('manager.events.event_update', [$event->eid]) }}" enctype="multipart/form-data" id="EventEditForm">
                    @csrf
                    <div id="dineInSection1" class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="event_name" class="form-label">{{ ('Event Name') }}: *</label>
                                <x-input value="{{ old('event_name') ?? $event->event_name }}" id="event_name" name="event_name" class="form-control"
                                    type="text" required />
                                @error('event_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <x-input value="{{ old('location') ?? $event->location }}" id="location" name="location" class="form-control"
                                    type="text" required />
                                @error('location')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div id="dineInSection1" class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <x-input value="{{ $event->start_datetime }}" id="start_time" name="start_time" class="form-control"
                                    type="text" required />
                                @error('start_time')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <x-input value="{{ $event->end_datetime }}" id="end_time" name="end_time" class="form-control"
                                    type="text" required />
                    ...
                    <div id="dineInSection1" class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <x-input value="{{ $event->event_date }}" id="event_date" name="event_date" class="form-control"
                                    type="text" required />
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="event_manager_id"  id="manager_id" class="form-control" required>
                                <option value="">Select Manager</option>
                                    <option {{ $event->manager->manager_id==$manager->manager_id?'selected':'' }} value="{{ $manager->manager_id }}">{{ $manager->name }}</option>
                            </select>
                    ...
                    <div id="dineInSection1" class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <x-input value="{{ $event->contact_no }}" id="phone_no" name="phone_no" class="form-control"
                                    type="text" required />
                                @error('phone_no')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div id="dineInSection1" class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span style="color:rgb(207, 208, 218);">If you want to update the Logo, insert only.<br>Size
                                        (600x400)</span>
                                    </label>
                                    <x-input value="{{ asset('public/uploads/events/logo/' . $event->logo) }}" id="Logo"
                                        name="Logo" class="form-control" type="file"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="banner" class="form-label"><span style="color:rgb(207, 208, 218);">If you want
                                            to update the Banner, insert only<br>Size(1920x1080)</span></label>
                                    <x-input value="{{ asset('public/uploads/events/banner/' . $event->banner) }}" id="banner"
                                        name="banner" class="form-control" type="file"
                                        accept=".jpeg,.png,.jpg,.gif,.svg,.jfif" />
                        ...
                        <div id="dineInSection2" class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="details-docs" class="form-label"><span style="color:rgb(207, 208, 218);">If you want
                        ...
                        <div class="d-flex mb-3">
                            <div class="d-grid">
                                <button class="btn btn-primary btn-block mt-2" type="submit">{{ __('Update Event') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
