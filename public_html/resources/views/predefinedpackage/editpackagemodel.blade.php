...
<form>
    <input type="hidden" id="package_id_hidden" value="{{ $packagedata->package_id}}">
   <div class="form-group">
       <label for="package_name" class="form-label">Package Name   *</label>
      <input type="text" name="package_name" id="package_name" class="form-control" value="{{ old('package_name') ?? $packagedata->package_name }}"  maxlength="100" required>
   </div>
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <select id="package_status" class="form-control" name="package_status" required>
            <option value="Active" {{ $packagedata->package_status == 'Active' ? 'selected' : '' }}>Yes</option>
            <option value="Inactive" {{ $packagedata->package_status == 'Inactive' ? 'selected' : '' }}>No</option>
        </select>
    </div>
