        ...
        <style>
            ...
            * {
            ...
            @media print {
                ...
                .invoice {
                    page-break-inside: avoid; /* Prevents page breaks inside the invoice container */
                    margin: 0 !important; /* Ensures no extra margin around the invoice on print */
                    padding: 10px; /* Adjust padding if needed */
                    background-color: #ffffff; /* Makes sure the background is white */
                }

                 /* Avoid empty space at the top */
                html, body {
                    height: 100%; /* Ensures content occupies full height */
                }
                ...
                .category-cell {
                    background-color: #838383 !important; /* Change the color for printing */
                    color: #fff !important;
                }
            ...
            body {
                ...
                /* Avoid breaking elements like tables between pages */
            }
...
<body>
    <div class="invoice">
        <div class="invoice-heading">
            ...
            <div class="right-wrap">
                <div class="address">
                    <address>
                        <strong>
                            <h4>{{ Str::title(str_replace('-', ' ', config('app.company_name')))}}</h4>
                        </strong>
        ...
        <div class="row invoice-details-wrap">
            <div class="col-xs-6">
                <address>
                    <p>QUOTATION TO :<b>{{ $customerName }}</b></p>
            ...
            <div class="col-xs-6 text-right">
                <address>
                  ...
                  @endif
                    ...
                    QUO DATE:{{ date('d/m/Y', strtotime($order->inv_date)) }}
            </div>
        </div>
        <table class="invoice-details">
            ...
            <tr>
                ...
                <td style="text-align: right;" colspan="{{ $confirmWithItemPrice == 'on'? 3 : 2 }}">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>Sub-total:</div>
                        <h5>
                            {{ number_format($finalAmount - $transport - $tax + $totalDiscount, 2) }}
                        </h5>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>Transport:</div>
            ...
            @if($special_note)
                <p><b>SPECIAL NOTE:</b> {{$special_note}}</p>
            @else
            ...
            {{-- <p>Special Note:</p>
            <?php
            echo 'Start Date: ' . $startTime . '<br>';
            echo 'End Date: ' . $endTime . '<br>';
            ?> --}}
        <br>
    ...
    <div class="form-group">
        <a class="btn btn-secondary" id="backButton" style="align-items: center" href="{{ url()->previous() }}">Go
            Back</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
