...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('useradmin.seo.contact') }}">{{ __('Contact') }}</a>
    </li>
@endsection
            ...
            <div class="col-md-10">
                <div class="card shadow-sm">
                    ...
                    <div class="card-header text-white bg-dark">
                        <h4 class="text-center">App Contact Images</h4>
                    </div>
                    <div class="card-body">
                        @php
                            $i = 0;
                        ...
                        <div class="masonry mb-4">
                            @foreach ($settings['app']['contact']['images'] as $filename => $image)
                                <div class="masonry-item ">
                                    ...
                                    <div style="justify-content: end;display: flex" class="mt-1 mb-2">
                                        <button class="btn btn-primary col-12"
                                            onclick="save('contact','{{ $filename }}')">Save</button>
                                    </div>
                                </div>
                                @php
                                    $i++;
