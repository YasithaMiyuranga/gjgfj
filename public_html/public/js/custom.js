...
$(document).on("submit", 'form[data-ajax="true"]', function (e) {
    ...
    var formData = new FormData(this); // Use FormData for multipart/form-data
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var successMessage =
                ...
                response.message +
                "</div>";
            form.prepend(successMessage); // Add the success message at the top of the form

            // Optionally reload the page after a delay or update content dynamically
            setTimeout(function () {
                location.reload(); // Reload the page after 2 seconds (2000 ms)
            }, 200);
        },
        error: function (xhr) {
            ...
            `;
                ...
                // Prepend the error list to the form
...
$(document).on("click", ".close-error", function () {
    $(this).closest(".alert").remove(); // Remove the alert box
});
...
// Prevents multiple form submissions by disabling the submit button on first click
(function() {
    $('.form-submit-click').on('submit', function(e) {
